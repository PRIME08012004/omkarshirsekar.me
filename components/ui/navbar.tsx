...
export default function Navbar() {
  ...
  const navContent = (
    <div
      className="flex items-center gap-3 px-12 py-2 rounded-4xl"
      style={{
        background:
    ...
    >
      ...
      <NavIcon href="https://drive.google.com/file/d/1ODWpkzfxffV2Wjn41MzYLJC7PzX6H_s6/view?usp=sharing" label="Resume Link">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
...
function NavIcon({
  ...
  const sharedClass =
    "flex items-center justify-center w-[34px] h-[34px] rounded-xl transition-all duration-75 relative group";
